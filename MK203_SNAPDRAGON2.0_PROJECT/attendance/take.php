 ...
 <body>
  ...
  <div class="container"> 
    <?php 
      ...
      echo '<h3>Work Site : '.$node->getCode(). ' ('.$node->getSection().') '.$node->getYear().'</h3>';
      echo '<h3>Number of days work done : '.$node->getDays().'</h3>';
    ...
    <div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
          ...
          <hr>
          <ol class="text-left">
            <li>Click on any worker ID to see his/her records, attendance percentage etc.</li>
            <li>The number next to any worker shows the number of days he/she has do there work</li>
            <li>Click the <button class="btn">A</button> button next to that ID to mark that worker as present</li>
            <li>Click the <button class="btn btn-success">P</button> button if you have accidentally marked that worker as present</li>
            <li>Click the <button class="btn btn-danger">&times;</button> button to delete that ID (can't undo this action)</li>
