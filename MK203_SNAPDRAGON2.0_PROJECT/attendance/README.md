...
The project is meant to create an advanced attendance taking system to help Supervisor, 
workers of mgnarega by automating the entire process. It is designed keeping 
